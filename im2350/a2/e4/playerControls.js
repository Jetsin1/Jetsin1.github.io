...
// the buttons for the controls (Buttons are organised according to display in html)
...
//Here I am creating a data sheet using an Array to create a list of all of the different songs that allows the rewindbutton and next button to function like going up and down the list in order
const Songs = ["https://thelongesthumstore.sgp1.cdn.digitaloceanspaces.com/IM-2250/p-hase_Hes.mp3", "https://thelongesthumstore.sgp1.cdn.digitaloceanspaces.com/IM-2250/p-hase_Dry-Down-feat-Ben-Snaath.mp3", 
"https://thelongesthumstore.sgp1.cdn.digitaloceanspaces.com/IM-2250/p-hase_Leapt.mp3", "https://thelongesthumstore.sgp1.cdn.digitaloceanspaces.com/IM-2250/p-hase_Water-Feature.mp3"]
//An array works where the first position starts at 0 so therefore the first song would be Songs[0]

//Here I am setting the audio element as a default of song[0] which is the first song 
audioElement.setAttribute('src', Songs[0])
...
function replayButton(){
  if(audioElement.loop) {
    ...
    loopButton.style.opacity = "0.3";
  }
}

loopButton.addEventListener('click', replayButton)


/* REWIND BUTTON */
//Im doing the rewind like spotify's rewind button where if you are more than 3 seconds into the song it will go back to the beginning when pressed
//However if you are less than 3 seconds into the song, it will go back to the previous song
function previousButton(){
  if(audioElement.currentTime	>= 3) {
    audioElement.currentTime = 0;
  } else if(audioElement.getAttribute('src') == Songs[0]){
    audioElement.setAttribute('src', Songs[3] );
    audioElement.play()
  } else if(audioElement.getAttribute('src') == Songs[1]){
    audioElement.setAttribute('src', Songs[0] );
    audioElement.play()
  } else if(audioElement.getAttribute('src') == Songs[2]){
    audioElement.setAttribute('src', Songs[1] );
    audioElement.play()
  } else {
    audioElement.setAttribute('src', Songs[2] );
    audioElement.play()
  }
} 

rewindButton.addEventListener('click', previousButton)
...
/* NEXT BUTTON */
//by using the same function and same premise of the previous button function just by setting the array number to the next song plays the next song because it checks for what position in terms of song it is in the array
...
nextButton.addEventListener('click', forwardButton)
...
/*  MUTE BUTTON */
//by creating a function similar to that of the playPause() function, the concept of the mute/unmute button was the same
function muteUnmute(){
...
/* This is the music selection to be able to select the different songs */
...
Song1.addEventListener('click', play1)
...
Song2.addEventListener('click', play2)
...
Song3.addEventListener('click', play3)
...
Song4.addEventListener('click', play4);
